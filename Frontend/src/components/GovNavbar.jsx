    ...
    <>
      ...
      <footer className="fixed xl:hidden visible bottom-[-2px] left-0 z-[999]  bg-white w-full h-15 px-3 shadow-3xl border-t-2 border-zinc-100">
        <div className=" flex items-center justify-between w-full h-full mb-10">
          <NavItem to="/gov" icon={Home} label="Home" className="flex" />
          <NavItem
            to="/gov/dashboard"
            icon={LayoutDashboard}
            label="Dashboard"
          />
          <NavItem to="/gov/search" icon={Search} label="Search" />
          <NavItem to="/gov/profile" icon={User2} label="Profile" />
          <NavItem to="/gov/settings" icon={Menu} label="Settings" />
        </div>
      </footer>
      <div className="fixed  xl:flex hidden left-0 z-[999]  bg-gray-100/50 border-1 border-gray-200 shadow-xl w-[20%] h-screen p-3 shadow-3xl border-t-2 border-zinc-100">
        <div className=" flex flex-col items-center justify-start w-full h-full mb-10">
          <NavItem2 to="/gov" icon={Home} label="Home" className="flex" />
          <NavItem2
            to="/gov/dashboard"
            icon={LayoutDashboard}
            label="Dashboard"
          />
          <NavItem2 to="/gov/search" icon={Search} label="Search" />
          <NavItem2 to="/gov/profile" icon={User2} label="Profile" />
          <NavItem2 to="/gov/settings" icon={Menu} label="Settings" />
        </div>
      </div>
    </>
  );
